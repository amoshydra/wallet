...
export default function ImportModal({ open, onImport, onClose }: ImportModalProps) {
  ...
  return (
    ...
    >
      ...
      <div className="form-group">
        <label htmlFor="importZipFile">Select ZIP File</label>
        <input
          id="importZipFile"
          ref={fileInputRef}
          type="file"
      ...
      <div className="form-group">
        <label htmlFor="importPassword">Password (if encrypted)</label>
